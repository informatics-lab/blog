...
In theatnformatics Lab, you find all the advantage of a startup:

* `Learn` a lot and `quickly`. You could work on several [projects]() at the same time, even if they are completely different. It's the best way to be efficient. If you are bored on one project, have a rush on the other. You should get to a point where both projects will help each other. Developing new skills is always rewarding. Moreover, the [team]() is really skilled. PhD, experience: they are using *100%* of their brain... and working with smart people is really stimulating and challenging. They are also always ready to help you. Don't hesitate to ask questions and be ready to give all your best!
